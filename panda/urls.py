...
from panda.api import (
    ...
    RelatedUploadResource,
    SearchSubscriptionResource,
    TaskResource,
    UserResource)
...
urlpatterns = [
    ...
    url(r'^check_activation_key/(?P<activation_key>[\w\d]+){}$'.format(
        trailing_slash()),
        views.check_activation_key,
        name="check_activation_key"),
    url(r'^activate%s$' % trailing_slash(),
    ...
    url(r'^check_available_space%s$' % trailing_slash(),
        views.check_available_space, name="check_available_space"),
    url(r'^data_upload%s$' % trailing_slash(),
        views.data_upload, name="data_upload"),
    url(r'^related_upload%s$' % trailing_slash(),
        views.related_upload, name="related_upload"),
